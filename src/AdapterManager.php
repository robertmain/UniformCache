...
class AdapterManager
{
     ...
     * Adapter settings
     *
     * An array of adapter settings keyed by the name of the adapter they belong to. For example the APCAdapter will be
     * passed any settings under the key of `APC`
     *
     * @var array
     */
     ...
     *
     * This is used to check that an adapter can be instanciated before it actually is instanciated. This is useful for
     * example to check that MySQL installed and we can connect before we instanciate a MySQL adapter.
     *
