...
class MySQL_DB
{
     ...
     *
     * The array (`self::$links`) is keyed using hostname, port, username with each element seperated by a douple pipe.
     * This method generates a key that can be used to retrieve the current MySQL resource link
     *
     ...
     *
     * This method is used to facilitate connection pooling as it means that the class can support multiple
     * connections to multiple servers simultaneously, but only ever opens one connection per server
     *
    ...
    public function query($query)
    {
        ...
        $real_params = array_merge([$statement, $formatstr], $params);
...
class MySQLAdapter implements Adapter
{
     ...
     *    | `username`        | Username to connect to MySQL with                               |
     *    | `password`        | Password to connect to MySQL with                               |
     *    | `database`        | Database to connect to                                          |
     *    | `table`           | Table to store cache entries in. This will be auto created      |
     */
